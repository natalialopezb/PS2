...
up12 = (w1+w2*fp1)/(1+w1+w2*fp1); %Control p3 function

rl1 = Kl1*Rlt*(m1/(Sxp*tl1+m1*tl1+m1))*10^3; %Transcription rate for gene 1
rl2 = Kl2*Rlt*(m2/(Sxp*tl2+m2*tl2+m2))*10^3; %Transcription rate for gene 2
rl3 = Kl3*Rlt*(m3/(Sxp*tl3+m3*tl3+m3))*10^3; %Transcription rate for gene 3 
